            ...
            <div className="contactcontainers">
                <div className="contactbox">
                    ...
                    <div className="contactmidcontent">
                        <p> <img src='/Assets/img/Icons/octicon_location-16.svg' alt="" /> Address: {siteDetails?.address}</p>
                        <p> <img src='/Assets/img/Icons/ph_phone.svg' alt="" />  Mobile: {siteDetails?.phoneNo}</p>
                        <p> <img src='/Assets/img/Icons/ic_outline-mail.svg' alt="" />Email: {siteDetails?.email}</p>
                    </div>
                ...
                <div className="contactsubcontainers">
                    <SkinHair />
                </div>
            </div>

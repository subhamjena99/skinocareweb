        ...
        <>
            ...
            <div className="productcontent1">
                ...
                <div className="productbutton12">
                    <button onClick={() => props?.addToCart(props?.details?._id)} disabled={props?.loading}>Add to cart <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
